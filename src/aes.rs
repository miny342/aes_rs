...
mod test {
    ...
    #[test]
    fn block_cipher() {
        let ans = *b"i\x97u\x82\xed\xcf\x1f\x840\x19\x93{\x18G\xe4v\xb7q2\xd1`\xb3\xb4\x03\x99M\x18\xe6\x06\xa1#(";
        let a = AES::new(AESkey::K128(*b"!\xf4\x02\xf2[\x1a\x0f\xd7\"\xb81i\xe1\x05\t\xf8"));
        let mut aa = [0u8; 32];
        a.encrypt_cbc(
            b"B\x85\xd1\x082\xa8\xed\xf4\xccyy\xe9\xa2W\xe1E\xdc\\\x93EI\xf6.\x0b\xf1\xdc`p\xe6|\xc4\xab",
            *b"\x8e\xb8\xben\xe3\xe3!\xb4K\x07\xd6\xb7\x0cNH\xba",
            &mut aa
        );
        assert_eq!(ans, aa);

        let ans = *b"\xffc\xc0\xa1\xb7)\xb5_\xc2\xe7\xb9z(\xe4R\xae\x85\x1f\x15\x1cw\xbc\x8b_\x05*\x9d\x1a";
        let a = AES::new(AESkey::K128(*b"!\xf4\x02\xf2[\x1a\x0f\xd7\"\xb81i\xe1\x05\t\xf8"));
        let mut aa = [0u8; 28];
        a.encrypt_ofb(
            b"(\xd0\xcd!\x12\x9bc)\xf5\xe8\xaaE\x8e\xef0\xfc\x14u8/\xf9\xd8\xd65\xd0\x10Dw",
            *b"\x0ft^\xcf\xf7\xa4!\x85R5w\xe2\xa4<\xe8\x18",
            &mut aa
        );
        assert_eq!(ans, aa);

        let ans = *b"(\xce\xc3\xef\xf5\x8d\x1d&\x7fw\x97\xe3\xd35\xac#\x88[\xae3\x04\xc8\x96\x82\xe5\xac\xcb\xee";
        let a = AES::new(AESkey::K128(*b"!\xf4\x02\xf2[\x1a\x0f\xd7\"\xb81i\xe1\x05\t\xf8"));
        let mut aa = [0u8; 28];
        a.encrypt_cfb(
            b"(\xd0\xcd!\x12\x9bc)\xf5\xe8\xaaE\x8e\xef0\xfc\x14u8/\xf9\xd8\xd65\xd0\x10Dw",
            *b"\x9a\xf5%\xbc\x0616\xbd@c\t\xd6\xb3,\x9f\x17",
            &mut aa
        );
        assert_eq!(ans, aa);
    }
